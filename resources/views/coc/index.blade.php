            ...
            <div class="card">
              <div class="card-body">
                <form action="{{ url('store') }}" method="post" id="topupForm">
                    @csrf
                    <center>
                      <h3 class="card-title mb-3">Form Top Up Clash Of Clans</h3>
                      <img src="img/coc.png" alt="" class="mb-2 rounded" style="width:50%;">
                    </center>
                    <div class="input-group mb-3">
                      <span class="input-group-text bg-success text-white">Username</span>
                      <input type="text" class="form-control" placeholder="Username Player" aria-label="Username" name="username" autofocus required>
                    </div> 
                    <div class="input-group mb-3">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <select class="form-select" id="inputGroupSelect01" name="nama_nominal">
